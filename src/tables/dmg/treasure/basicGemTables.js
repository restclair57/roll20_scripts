Rob20.registerTable({
  "name": "Rob20-Tables-Dmg-Treasure-gemDescsOne",
  "showplayers": false,
  "entryType": "simple",
...
Rob20.registerTable({
  "name": "Rob20-Tables-Dmg-Treasure-gemDescsTwo",
  "showplayers": false,
  "entryType": "simple",
...
Rob20.registerTable({
  "name": "Rob20-Tables-Dmg-Treasure-gemDescsThree",
  "showplayers": false,
  "entryType": "simple",
...
Rob20.registerTable({
  "name": "Rob20-Tables-Dmg-Treasure-gemDescsFour",
  "showplayers": false,
  "entryType": "simple",
...
Rob20.registerTable({
  "name": "Rob20-Tables-Dmg-Treasure-gemDescsFive",
  "showplayers": false,
  "entryType": "simple",
...
Rob20.registerTable({
  "name": "Rob20-Tables-Dmg-Treasure-gemDescsSix",
  "showplayers": false,
  "entryType": "simple",
...
Rob20.registerTable({
  "name": "Rob20-Tables-Dmg-Treasure-basicGems",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,25,"[[1t[Rob20-Tables-Dmg-Treasure-gemDescsOne]]] ([[4d4]] gp)"],
    [26,50,"[[1t[Rob20-Tables-Dmg-Treasure-gemDescsTwo]]] ([[2d4*10]] gp)"],
    [51,70,"[[1t[Rob20-Tables-Dmg-Treasure-gemDescsThree]]] ([[4d4*10]] gp)"],
    [71,90,"[[1t[Rob20-Tables-Dmg-Treasure-gemDescsFour]]] ([[2d4*100]] gp)"],
    [91,99,"[[1t[Rob20-Tables-Dmg-Treasure-gemDescsFive]]] ([[4d4*100]] gp)"],
    [100,100,"[[1t[Rob20-Tables-Dmg-Treasure-gemDescsSix]]] ([[2d4*1000]] gp)"]
  ]
});
