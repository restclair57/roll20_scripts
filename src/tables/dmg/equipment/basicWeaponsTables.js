Rob20.registerTable({
  "name": "Rob20-Tables-Dmg-Equipment-commonMeleeWeaponsItems",
  "showplayers": true,
...
Rob20.registerTable({
  "name": "Rob20-Tables-Dmg-Equipment-uncommonWeaponsItems",
  "showplayers": true,
  "entryType": "rollWeights",
  "entries": [
    [1,3,"orc double axe"],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Dmg-Equipment-commonRangedWeaponsItems",
  "showplayers": true,
  "entryType": "rollWeights",
  "entries": [
    [1,10,"[[1t[Rob20-Tables-Dmg-Equipment-commonAmmunitionItems]]]"],
    [11,15,"throwing axe"],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Dmg-Equipment-commonAmmunitionItems",
  "showplayers": true,
  "entryType": "rollWeights",
  "entries": [
    [1,50,"50 Arrows"],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Dmg-Equipment-randomWeaponsTable",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,70,"[[1t[Rob20-Tables-Dmg-Equipment-commonMeleeWeaponsItems]]]"],
    [71,80,"[[1t[Rob20-Tables-Dmg-Equipment-uncommonWeaponsItems]]]"],
    [81,100,"[[1t[Rob20-Tables-Dmg-Equipment-commonRangedWeaponsItems]]]"]
  ]
});
