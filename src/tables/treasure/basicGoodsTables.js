Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsOne",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,90,""],
    [91,95,"[[1t[Rob20-Tables-Treasure-basicGems]]]"],
    [96,100,"[[1t[Rob20-Tables-Treasure-basicArtObjects]]]"]
  ]
});

Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsTwo",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,81,""],
    [82,95,"[[[[1d3]]t[Rob20-Tables-Treasure-basicGems]]]"],
    [96,100,"[[[[1d3]]t[Rob20-Tables-Treasure-basicArtObjects]]]"]
  ]
});

Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsThree",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,77,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsFour",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,70,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsFive",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,60,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsSix",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,56,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsSeven",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,48,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsEight",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,45,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsNine",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,40,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsTen",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,35,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsEleven",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,24,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsTwelve",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,17,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsThirteen",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,11,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsFourteen",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,11,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsFifteen",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,9,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsSixteen",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,7,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsSeventeen",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,4,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsEighteen",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,4,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsNineteen",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,3,""],
...
Rob20.registerTable({
  "name": "Rob20-Tables-Treasure-BasicGoodsTwenty",
  "showplayers": false,
  "entryType": "rollWeights",
  "entries": [
    [1,2,""],
